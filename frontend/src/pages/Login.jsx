        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 bg-[--theme-clr] p-[5vw] lg:p-[1.5vw] rounded-[2.5vw] lg:rounded-[1vw] custom-shadow h-[91vh] w-[95vw] lg:w-[78vw]">
          <div className="hidden lg:block">
            ...
            >
              <SwiperSlide>
                <img
                  className="h-full w-full object-cover rounded-tl-[2.5vw] rounded-bl-[2.5vw] lg:rounded-tl-[1vw] lg:rounded-bl-[1vw]"
          ...
          <div className="flex flex-col justify-center w-full lg:w-[37.5vw] h-auto lg:h-[85vh] mx-auto text-[--neutral] gap-[3vw] lg:gap-[1.5vw] px-[5vw]">
            ...
            <div className="w-full">
              <form className="grid gap-[2vw] lg:gap-[0.75vw] w-full">
                ...
                <label className="text-[3vw] lg:text-[1vw] flex items-center w-full gap-1">
                  <input
                    type="checkbox"
                    className="h-[3vw] lg:h-[1vw] w-[3vw] lg:w-[1vw]"
                  />{" "}
                  Remember Me
                </label>
                <button className="bg-[--light-purple] text-white font-semibold w-full h-[10vw] lg:h-[3.75vw] rounded-[1.25vw] lg:rounded-[0.5vw] text-[4vw] lg:text-[1.25vw]">
                  Login
                </button>
