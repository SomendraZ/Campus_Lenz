...
export default function EventBanner({
	...
	return (
		<>
			<Link
				to="/"
				className="flex flex-col max-w-xl rounded-lg text-gray-800 relative hover:scale-[1.025] shadow-[_3px_3px_rgba(100,_97,_81,_0.6),_6px_6px_rgba(100,_97,_81,_0.4),_9px_9px_rgba(100,_97,_81,_0.2)] transition-all bg-[#f6e8ce]"
			>
				<div>
